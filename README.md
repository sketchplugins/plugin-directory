...
- [Sketch Auto Mask](http://sketchautomask.com), by Patrick Hill: A better masking tool. Create a mask snapped to a selected group, image, or layer with a handy shortcut. The mask stays selected for easy editing.
