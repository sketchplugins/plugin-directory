...
List of Sketch plugins hosted at GitHub in last updated order
...
Prepend new line to [plugins.json](edit/master/plugins.json) with `{ "name": "github_name", "name": "github_repo_name" }` and open pull request.
