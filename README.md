...
- [keremciu/sketch-use-fontawesome](https://github.com/keremciu/sketch-use-fontawesome) Its a nice plugin to use fontawesome in Sketch for developers and designers.
