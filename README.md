...
- [KivyGogh/Coffee-Slice](https://github.com/KivyGogh/Coffee-Slice) A Sketch plugin to make the standard slicing with a user-given viewBox size automatically.
