...
- if your plugin is on GitHub and `*.sketchplugin/Contents/Sketch/manifest.json` or `src/manifest.json` is available [edit github.txt](edit/master/directory/github.txt)
