...
- [Easing Gradient](https://github.com/larsenwork/sketch-easing-gradient), by Andreas Larsen: Create, edit and generate code for easing gradients and utilise different color spaces.
